...
import { CAPTCHA } from '../config/constants.js';
...
export function generateCaptcha() {
  const operations = [
    { type: 'add', symbol: '+', ...CAPTCHA.OPERATIONS.ADD },
    { type: 'subtract', symbol: '-', ...CAPTCHA.OPERATIONS.SUBTRACT },
    { type: 'multiply', symbol: '×', ...CAPTCHA.OPERATIONS.MULTIPLY }
  ];
