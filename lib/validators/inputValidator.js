...
export function isValidName(name) {
  ...
  // Only letters, spaces, hyphens, and common accented characters
  const nameRegex = /^[a-zA-ZåäöÅÄÖéèêëúùûüíìîïóòôõœøæ\s\-']+$/;
...
export function isValidBudget(budget) {
  ...
  return !isNaN(num) && num >= 0 && num <= 10000000;  // Max 10 million SEK
}
