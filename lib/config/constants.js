 ...
 * ├─────────────────────────────────────┤
 * │ Privacy Modal (100)                 │ <- Highest priority
 * ├─────────────────────────────────────┤
 * │ Tooltips (80)                       │
 * ├─────────────────────────────────────┤
 * │ Toast Notifications (70)            │
 * ├─────────────────────────────────────┤
 * │ Cookie Banner / Install Prompt (60) │ <- Same level (never show together)
 * ├─────────────────────────────────────┤
 * │ Modals (50)                         │ <- ProjectSlideshow, etc.
 * ├─────────────────────────────────────┤
 * │ Overlays (40)                       │
 * ├─────────────────────────────────────┤
 * │ Sticky Elements (30)                │
 * ├─────────────────────────────────────┤
 * │ Fixed Elements (20)                 │ <- Footer
 * ├─────────────────────────────────────┤
 * │ Dropdowns (10)                      │
 * ├─────────────────────────────────────┤
...
export const Z_INDEX = {
  /**
   * Base level - normal content flow
   */
  BASE: 0,
   ...
   * PWA install prompt
   */
  INSTALL_PROMPT: 60, // Same level as cookie banner (they don't show together)
  ...
  /**
   * Privacy policy (highest priority modal)
   */
  PRIVACY_MODAL: 100,
